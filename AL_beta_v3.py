...
class Menu(tk.Frame):
    def __init__(self, parent, mostrar_frame,frame_header):
        ...
        self.L_menu_button = tk.Button(self, text="Libros ▼", bg="#00FF29", fg="#333333", font=("Inter", 24), relief="raised", command=self.show_menu, anchor="w", padx=10)
        self.L_menu_button.place(x=1.0, y=0, width=213.0, height=58.0)

        # Crear el menú desplegable
        self.dropdown_menu = tk.Menu(self, tearoff=0, bg="lightgreen", fg="#333333", font=("Inter", 24),
        ...
        self.dropdown_menu.entryconfig("Registrar", font=("Helvetica", 24), accelerator=" "*20)
        self.dropdown_menu.entryconfig("Listado", font=("Helvetica", 24), accelerator=" "*20)

    def show_menu(self):
        self.dropdown_menu.post(self.L_menu_button.winfo_rootx(), self.L_menu_button.winfo_rooty() + self.L_menu_button.winfo_height())
