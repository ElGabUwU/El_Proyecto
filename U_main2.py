...
class Registrar(tk.Frame):
    ...
    def create_widgets(self):
        ...
        canvas.create_text(263.0, 106.0, anchor="nw", text="Ingrese la información del nuevo usuario a agregar", fill="#4C4C4C", font=("Montserrat Medium", 15))
        #fila 1
        canvas.create_text(263.0, 152.0, anchor="nw", text="Cargo", fill="#000000", font=("Montserrat Regular", 15))

        #fila 2
        canvas.create_text(263.0, 252.0, anchor="nw", text="Nombre", fill="#000000", font=("Montserrat Regular", 15))
        canvas.create_text(520.0, 252.0, anchor="nw", text="Apellido", fill="#000000", font=("Montserrat Regular", 15))
        canvas.create_text(779.0, 252.0, anchor="nw", text="Cedula", fill="#000000", font=("Montserrat Regular", 15))
        
        
        #fila 3
        canvas.create_text(263.0, 352.0, anchor="nw", text="Nombre de usuario", fill="#000000", font=("Montserrat Regular", 15))
        canvas.create_text(520.0, 352.0, anchor="nw", text="Contraseña", fill="#000000", font=("Montserrat Regular", 15))
...
class Eliminar(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.images["button_image_1"] = tk.PhotoImage(file=relative_to_assets("U_volver.png"))
        ...
        self.label_info = canvas.create_text(263.0, 106.0, anchor="nw", text="Ingrese la información del usuario a Eliminar", fill="#4C4C4C", font=("Montserrat Medium", 15))
        
        # Texto para el nombre
        self.label_nombre = canvas.create_text(263.0, 152.0, anchor="nw", text="Cedula", fill="#000000", font=("Montserrat Regular", 15))
        ...
        # Texto del navbar
        self.navbar_title = canvas.create_text(226.0, 5.0, anchor="nw", text="Eliminar", fill="#000000", font=("Inter", 40 * -1))
...
class Modificar(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Titulos de los inputs
        canvas.create_text(263.0, 106.0, anchor="nw", text="Ingrese la información del usuario a modificar", fill="#4C4C4C", font=("Montserrat Medium", 15))
        #fila 1
        canvas.create_text(263.0, 152.0, anchor="nw", text="Cargo", fill="#000000", font=("Montserrat Regular", 15))
